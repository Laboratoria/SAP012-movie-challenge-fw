// Componente que exibe uma lista de filmes
...
export class MovieListComponent {
  @Input() movies: Movie[] = [];  //Definir um Input chamado movies do tipo Movie[] que represente um array de modelos de negócios Movie ou seja // Array de filmes recebido do componente pai //
}
