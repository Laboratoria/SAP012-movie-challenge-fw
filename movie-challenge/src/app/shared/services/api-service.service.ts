...
// Decorador que indica que essa classe é um serviço Angular e pode ser injetada em outros componentes
@Injectable({
  providedIn: 'root'
})
...
export class APIService {
  ...
  getMovies(): Observable<Movie[]> {
    ...
    return this.http.get<any>(`${environment.URL_API}/discover/movie`, { headers }).pipe(
